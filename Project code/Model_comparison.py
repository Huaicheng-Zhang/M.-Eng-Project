'''this program compares the performance of ADWL with other common ML methods in terms of prediction error
(linear regression, decision tree, random forest and support vector machine)'''
...
# y_arima = arima.fit(X_training, Y_training)
