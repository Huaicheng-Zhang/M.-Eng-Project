'''this file compares the performance of ADWL with simple SVR model 
when predicting a congestion point'''
...
#feature: intensidad or vmed (intensity or speed)
df_intensidad_1 = dfa[['vmed']]
...
#resampling. Original data has 15-minute sampling period
df_total_1 = df_total_1.resample('5min')
...
#converting numbers in an array
